###---------------------------------------------------------------------####
# LPM & Logit: How Does Trust in Government Vary by Race, Income, and Education?
# Author: Allie Sensinger
# Data: anes_all_cleaned_vars.csv
# Method: K-1 dummy coding (White = ref for race, High school graduate = ref for educ,
#         Under $25,000 = ref for income)
# DV: trust_binary (1 = trusts government at least sometimes, 0 = never)
###---------------------------------------------------------------------####
